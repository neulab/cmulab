...
set -x
    ...
    echo python -u utils/prepare_data.py  \
    ...
    echo python -u utils/denoise_outputs.py \
    ...
    echo python -u postcorrection/create_vocab.py \
    ...
    echo python -u postcorrection/multisource_wrapper.py \
    --dynet-mem $dynet_mem \
    --dynet-autobatch 1 \
