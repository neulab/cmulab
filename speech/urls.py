...
urlpatterns = [
    ...
    path('speech/corpus/<int:pk>/removesegments/<str:s_list>/', views.removesegmentsfromcorpus, name='corpussegment-remove'),
    ...
    path('speech/segment/<int:pk>/addannotations/<str:s_list>/', views.addannotationstosegment, name='segmentannot-add'),
    path('speech/segment/<int:pk>/removeannotations/<str:s_list>/', views.removeannotationsfromsegment, name='segmentannot-remove'),
