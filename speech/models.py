...
class Annotation(models.Model):
	...
	'''
	field_name = models.CharField(max_length=100, help_text='The name of the field within the segment')
	segment = models.ForeignKey('Segment', related_name='annotation', on_delete=models.CASCADE, help_text='The segment that this annotation corresponds to. (foreign key)')
	CORRECT = 'correct'
	INCORRECT = 'incorrect'
	GENERATED = 'generated'
	UNKNOWN = 'unknown'
	STATUS_CHOICES = [(CORRECT, 'correct'), (INCORRECT, 'incorrect'), (GENERATED, 'generated'), (UNKNOWN, 'unknown')]
	status = models.CharField(choices=STATUS_CHOICES, max_length=20, default=UNKNOWN, help_text='describes the status of the annotation e.g. correct/incorrect, or generated by a backend model (but not checked), or unknown')
